...
void joystickJos(void){
	...
	if(treapta==1){
		varAfisare=(unsigned char *)("jos1");
		servoDelay=650;
	}
	if(treapta==2){
		varAfisare=(unsigned char *)("jos2");
		servoDelay=500;
	}
	if(treapta==3){
		varAfisare=(unsigned char *)("jos3");
		servoDelay=350;
	}
	if(treapta>3){
		reset();
  ...
  for(;;)
  {
	  ...
	  if(servoDelay){
		  ...
		  if (currentMillis - previousMillis >= 2*servoDelay){
		  	 previousMillis=currentMillis;
		  	 if(servoDelay==750){ //daca e in sus sa miste o singura data
		  		TIM3 ->CCR4=450;
		  		HAL_Delay(100);
		  		servoDelay=0;
		  	 }
  ...
  for(;;)
  {
	  //gasire pozitie joystick
	  			  ...
	  			  HAL_Delay(300);
	  			  	...
	  			  	if ((VR[0]<1000)  && (VR[1]>=1000) && (VR[1]<=3500)){ //stanga
	  			  		joystickStanga();

	  			  	}

	  			  	if ((VR[0]>3500)  && (VR[1]>=1000) && (VR[1]<=3500)){ //dreapta
	  			  		joystickDreapta();
	  			  	}

	  			  	if ((VR[0]>=1000) && (VR[0]<=3500) && (VR[1]<1000)){   //sus
	  			  	    joystickSus();
	  			  	}

	  			  	if ((VR[0]>=1000) && (VR[0]<=3500) && (VR[1]>3500)){   //jos
	  			  		treapta=treapta+1;
	  			  		joystickJos();
	  			  	}

	  			  	if ((VR[0]<1000) && (VR[1]>3500)){ //stanga-jos
	  			  		joystickStangaJos();
	  			  	}

	  			  	if ((VR[0]>3500) && (VR[1]>3500)){ //dreapta-jos
	  			  	  	reset();
	  			  	}

	  			  	if ((VR[0]>3500) && (VR[1]<1000)){//dreapta-sus
	  			  		joystickDreaptaSus();
	  			  	}

	  			  	if ((VR[0]<1000) && (VR[1]<1000)){ //stanga-sus
	  			  		joystickStangaSus();
	  			  	}
    osDelay(1);
  }
...
void Afisare(void *argument)
{
  ...
  for(;;)
  {
	  ...
	  if(varAfisare==(unsigned char *)("sus")){
		  afisareSus();
	  }

	  if(varAfisare==(unsigned char *)("jos1"))
		  afisareJos1();
	  if(varAfisare==(unsigned char *)("jos2"))
	 	  afisareJos2();
	  if(varAfisare==(unsigned char *)("jos3"))
	 	  afisareJos3();

	  if(varAfisare==(unsigned char *)("stanga-sus")){
		  afisareStropParb();
	  }

	  if(varAfisare==(unsigned char *)("dreapta-sus")){
		  afisareStropLun();
	  }

	  if(varAfisare==(unsigned char *)("dreapta")){
		  afisareDreapta();
	  }

	  if(varAfisare==(unsigned char *)("stanga")){
		  afisareStanga();
	  }

	  if(varAfisare==(unsigned char *)("stanga-jos")){
		  afisareAvarii();
	  }

	  if(varAfisare==(unsigned char *)("sus") ||
		 varAfisare==(unsigned char *)("stanga-sus") ||   //pentru toate modurile unde
		 varAfisare==(unsigned char *)("dreapta-sus") ||  //servo-motorul nu merge in bucla
		 varAfisare==(unsigned char *)("dreapta") ||
		 varAfisare==(unsigned char *)("stanga")){
		  	  if (currentMillis - previousMillis2 >= 3000){  //dupa 3 secunde sa se opreasca afisarea
		  			  varAfisare=(unsigned char *)("default");
		  	  	  }
	  }
    osDelay(1);
